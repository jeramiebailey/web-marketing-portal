...
ALLOWED_HOSTS = ['portalbackend.321staging.com']
...
STATICFILES_STORAGE = "config.settings.staging.StaticRootS3Boto3Storage"
...
# endregion
DEFAULT_FILE_STORAGE = "config.settings.staging.MediaRootS3Boto3Storage"
...
FRONTEND_URL = env('FRONTEND_URL', default='https://portal-frontend.321staging.com')
BACKEND_URL = env('BACKEND_URL', default='https://portalbackend.321staging.com')